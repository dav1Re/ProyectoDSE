...
set_property PACKAGE_PIN P4 [get_ports {enable}]					
...
set_property PACKAGE_PIN T16 [get_ports btn_izq]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_izq]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports btn_dcha]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_dcha]
